...
<body>
  <div class="container-xxl bg-white p-0">
          ...
          <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
              <div class="navbar-nav mr-auto py-0">
                ...
                <a href="Pemesanan.php" class="nav-item nav-link active">Booking</a>
    ...
    $destinasi = mysqli_query($connection, "SELECT * FROM destinasi WHERE ID_Destinasi = $ID_Destinasi");
    $row = mysqli_fetch_array($destinasi);
    $harga = $row['Harga'];
    ?>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="mb-5">
            Book A
            <span class="text-primary text-uppercase">FAST TRAVEl TOURS</span>
          </h1>
        </div>
        <div class="row g-5">
          <div class="col-lg-6">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    <div class="form-floating">
                      <select class="form-control" name="ID_Admin" style="background-color: #fff;" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-floating">
                      <select class="form-control" name="ID_Destinasi" id="ID_Destinasi" style="background-color: #fff;" required>
                        <option value="">--Pilih--</option>
                        <?php
                        $array_destinasi = mysqli_query($connection, "SELECT * FROM destinasi");
                        while ($destinasi = mysqli_fetch_array($array_destinasi)) {
                          $selected = ($destinasi['ID_Destinasi'] == $ID_Destinasi) ? 'selected' : '';
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="Nama_Pemesan" name="Nama_Pemesan" placeholder="Your Name" required />
                      <label for="Nama_Pemesan">Your Name</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-floating">
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <input class="form-control" type="date" id="Tanggal_Pemesanan" name="Tanggal_Pemesanan" required>
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="Harga" name="Harga" placeholder="Harga Per Tiket" value="<?php echo number_format($row['Harga'], 0, ',', '.'); ?>" readonly />
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <input type="number" class="form-control" id="Jumlah_Tiket" name="Jumlah_Tiket" placeholder="Jumlah Tiket" oninput="updateTotalHarga()" required />
  ...
  <script>
    function updateTotalHarga() {
      var harga = parseInt(document.getElementById("Harga").value.replace(/\D/g, "")) || 0;
    ...
    document.getElementById("ID_Destinasi").addEventListener("change", function() {
      var destinasi = this.value;
      var xhr = new XMLHttpRequest();
      xhr.open("GET", "proses_booking.php?destinasi=" + destinasi, true);
      xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
          var harga = xhr.responseText;
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      updateTotalHarga(); // Update total harga initially
    });
  </script>
    ...
    <div class="container pb-5">
      <div class="row g-5">
        <div class="col-md-6 col-lg-4">
          <div class="bg-primary rounded p-4">
            ...
            <p class="text-white mb-0">
              Download
              <a class="text-dark fw-medium" href="https://htmlcodex.com/hotel-html-template-pro">Hotelier – Premium Version</a>, build a professional website for your hotel business and
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <p class="mb-2">
            <i class="fa fa-map-marker-alt me-3"></i>FINAL EDUWORK Kelompok
            2
          </p>
          <p class="mb-2">
